...
Page({
  ...
  onLoad: function(options) {
    ...
    app.setNavigationBarTitle('拼团管理')
  ...
  getPostlist(e) {
    ...
    app.api.prequest({
      ...
      res.data.forEach(item => {
        item.img = app.util.getImgUrl(item.showImgs)
  ...
  clickBtn(e) {
    if (e.currentTarget.dataset.field =='detail'){
      return wx.navigateTo({
        url: '/pages/assemble/manage/orderdetail?id=' + e.currentTarget.dataset.id,
      })
    }
    let goodsId = e.currentTarget.dataset.id,
      actions = app.com.getOperation(['share', 'top', 'refresh', 'over', 'upOrDown'])
  ...
  handleClickItem(e) {
    ...
    switch (item.field) {
      ...
      case 'edit':
        wx.navigateTo({
          url: `/pages/assemble/manage/release?id=${goodsId}`,
        })
        this.handleCancel()
        return;
    }
